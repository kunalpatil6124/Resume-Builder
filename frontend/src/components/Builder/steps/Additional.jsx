...
export default function Additional() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="p-4 bg-gray-50 dark:bg-muted border border-border rounded-md mb-2">
        ...
        <div className="flex items-center gap-4">
          ...
          <select 
            ...
            className="rounded border border-border bg-transparent px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-primary"
          >
      ...
      <div className="mt-2 flex items-center gap-3">
        <input 
          ...
          onChange={handleChange}
          className="w-4 h-4 text-primary bg-transparent border-border rounded focus:ring-primary disabled:opacity-50"
        />
